...
namespace AbacasX.UI.Services
    ...
    public class StockTicker
        ...
        private void LoadDefaultStocks()
            ...
            {
                new Stock { Symbol = "@AAPL", Price = 207.53m },
                new Stock { Symbol = "@GOOG", Price = 1237.61m },
                new Stock { Symbol = "@MSFT", Price = 109.00m },
                new Stock { Symbol = "@GOLD", Price = 1198m },
                new Stock { Symbol = "@BTC", Price = 6441m }
