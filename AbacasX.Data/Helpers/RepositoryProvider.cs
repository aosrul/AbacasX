...
namespace AbacasX.Data.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </remarks>
        public IRepository<T, I> GetRepositoryForEntityType<T, I>() where T : class
        {
            return GetRepository<IRepository<T, I>>(_repositoryFactories.GetRepositoryFactoryForEntityType<T, I>());
        }
