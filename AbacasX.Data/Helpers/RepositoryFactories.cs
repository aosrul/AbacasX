...
namespace AbacasX.Data.Helpers
{
    /// <summary>
    /// A maker of AbacasX Repositories.
    /// </summary>
    /// <remarks>
    ...
    public class RepositoryFactories
    {
        ...
        /// <summary>
        /// Return the runtime AbacasX repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM AbacasX FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetAbacasXFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(IClientAccountHolderRepository),  dbContext => new ClientAccountHolderRepository(dbContext)},
                   {typeof(IOrderFilledMatchRepository),     dbContext => new OrderFilledMatchRepository(dbContext)},
                };
        }

        /// <summary>
        /// Constructor that initializes with runtime AbacasX repository factories
        /// </summary>
        public RepositoryFactories()
        {
            _repositoryFactories = GetAbacasXFactories();
        }
        ...
        /// </remarks>
        public Func<DbContext, object> GetRepositoryFactoryForEntityType<T,I>() where T : class
        {
            return GetRepositoryFactory<T>() ?? DefaultEntityRepositoryFactory<T,I>();
        }
        ...
        protected virtual Func<DbContext, object> DefaultEntityRepositoryFactory<T,I>() where T : class
        {
            return dbContext => new EFRepository<T,I>(dbContext);
        }
    }
}
